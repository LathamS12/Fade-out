...
**********************************************************************************************************************************	;	
	...
	************************
		...
		subgroup "2010" "RSCALEz MSCALEz" "LOWSES BLACK HISP"  "$demog"	 "a_samp3" 	"- Literacy and math"	
	...
	*********************************
	...
	//Interactions w/preschool
		...
		**********************************************
				...
				foreach x in `outcome' 	{
					...
					foreach subsamp in `subgroups' {
						...
						loc age = "X1KAGE AGE_SEPTK " //fall
							...
							mi estimate, post: reg *1`x' PRESCHOOL2 HEADSTART `age' `controls' `weight' if `sample' ==1 & `subsamp' ==1, cl($cluster)						
		...
		end //ends program "figs"
		
		figs "2010" "RSCALEz MSCALEz" "ALL BLACK HISP LOWSES"  "$demog"	 "csamp3" 	"- Literacy and math"	
		...
		foreach i in 1 2 4 7	{
			...
			mi estimate, post: reg X`i'RSCALEz PRESCHOOL2 HEADSTART `age' $demog `weight' if  a_samp3 ==1 & BLACK==1 & K2010==0, cl(${cluster})
			estimates store wave`i'_98
			
			mi estimate, post: reg X`i'RSCALEz PRESCHOOL2 HEADSTART `age' $demog `weight' if  a_samp3 ==1 & BLACK==1 & K2010==1, cl(${cluster})
			estimates store wave`i'_10	
