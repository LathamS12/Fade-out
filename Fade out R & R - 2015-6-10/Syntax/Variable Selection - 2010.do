...
* 
* Uses:
*	"F:\NCES Data\ECLS-K\Extracted Data\ECLS-K 2010 K-1.dta"
*
* Creates: 
...
pause on
	...
	cd "F:\NCES Data\ECLS-K\Extracted Data"
			
	*******************
	*  Base year 2010
	*******************	
		use "ECLS-K 2010 K-1", clear
	...
	**************************
	...
	cd "F:\Scott\Fade Out\Generated Datasets"
	save "Fade Out Raw 2010", replace
