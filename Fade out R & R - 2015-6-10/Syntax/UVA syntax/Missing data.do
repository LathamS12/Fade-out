...
*************************************************************/
	...
	********************
		...
		use "F:\Scott\Fade Out\Generated Datasets\Fade Out Clean 1998", clear

			capture log close
			log using "F:\Scott\Fade Out\Logs\Imputation 1998", replace
			...
			**************************
			...
			//Set and register the data
				...
				mi impute chained (regress) ${impute} = ${reg}, add(20)	
			...
			save "F:\Scott\Fade Out\Generated Datasets\Fade Out Final 1998", replace

	********************
	*	2010
	********************
		use "F:\Scott\Fade Out\Generated Datasets\Fade Out Clean 2010", clear

			capture log close
			log using "F:\Scott\Fade Out\Logs\Imputation 2010", replace
		...
		#delimit cr
			...
			**************************
			...
			save "F:\Scott\Fade Out\Generated Datasets\Fade Out Final 2010", replace
