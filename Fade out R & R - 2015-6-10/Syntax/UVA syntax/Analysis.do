...
pause on
global path "F:\Scott\Fade Out\Generated Datasets"
	...
	********************************************
		...
		program define subgroup
			args year outcome subgroups controls sample filename
				...
				use "$path\Fade Out Final `year'", clear
				...
				preserve
					postclose `name'
					use `file', clear				
					export excel using "F:\Scott\Fade Out\Tables\Subgroups `year' `filename'", replace
				restore
	...
	*********************************
		...
		program moderators
			args year grade weight sample filename prescore
				...
				use "F:\Scott\Fade Out\Generated Datasets\Fade Out Final `year'", clear
			...
			preserve
				use `file', clear
				export excel using "F:\Scott\Fade Out\Tables/Moderator analysis `year'`filename'.xls", replace
			restore
